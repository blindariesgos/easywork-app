                      ...
                      onChange={(e) =>
                        setSelectedContacts(
                          e.target.checked
                            ...
                            : selectedContacts.filter((p) => p !== agent.id)
                        )
                      }
                    />
                    <Menu
                        ...
                        {column.row == "name" ? (
                          ...
                          >
                            <Image
                              ...
                              width={30}
                              height={30}
                              src={agent?.user?.avatar || "/img/avatar.svg"}
                              alt=""
                            />
                            <div className="flex flex-col">
                              <p className="text-start">{agent?.name}</p>
                              {agent.bio && (
                          ...
                          <p className="text-center">
                            {formatDate(agent.createdAt, "dd/MM/yyyy") ?? "-"}
                          </p>
