...
export default function AccompanimentsHeader() {
  ...
  const options = [
    {
      name: 'Agente',
      onclick: () => router.push('/agents-management/accompaniment/agent?show=true'),
    },
    {
      name: 'Tarea',
    ...
    },
    {
      ...
      options: [
        {
          name: 'Individual',
          onclick: () => router.push('/agents-management/meetings-and-sessions/individuals/meet?show=true'),
        },
        {
          name: 'De Equipo',
          onclick: () => router.push('/agents-management/meetings-and-sessions/teams/meet?show=true'),
        },
      ],
    },
    ...
    <header className="flex flex-col">
      <div className="px-4 flex flex-col gap-2  bg-white py-4 rounded-md shadow-sm w-full">
        <div className="flex gap-3 flex-wrap w-full items-center">
          <h1 className="text-2xl font-semibold leading-6 text-gray-900 hidden md:block">{t('agentsmanagement:accompaniments:title')}</h1>
          <Menu>
