...
export const CourseFolder = ({
  ...
  const [isDeleteContentModalOpen, setIsDeleteModalContentOpen] =
    useState(false);
  ...
  return (
    <div className="mt-1.5">
      ...
      >
        {courseFolderPages?.length > 0 &&
          courseFolderPages.map((page, i) => {
            ...
            return (
              <div
                key={page.id}
                className={`${isFirstElement || isLastElement ? "" : "my-1"}`}
              >
                <CourseFolderPage
                  page={page}
                  ...
                  changeCourseFolder={() =>
                    changeCourseFolder(page, courseFolder)
                  }
        ...
        {hasPermission(LMS_PERMISSIONS.addPage) && (
      ...
      <AssignPageModal
        course={course}
        page={contentToHandle.current.content}
        isOpen={isAssignPageModalOpen}
        setIsOpen={setIsAssignPageModalOpen}
      />
