...
export const DeleteQuestionModal = ({ isOpen, setIsOpen, onClose, onSuccess }) => {
  const onCloseModal = () => {
    if (onClose) onClose();
    ...
    <Dialog open={isOpen} onClose={onCloseModal} className="relative z-50">
      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-2 ">
        <DialogPanel className="w-96 space-y-8  p-6 rounded-xl bg-gray-100">
          <DialogTitle className="font-bold">¿Está seguro de que desea eliminar esta pregunta?</DialogTitle>
