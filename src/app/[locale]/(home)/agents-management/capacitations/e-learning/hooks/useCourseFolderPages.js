...
export const useCourseFolderPages = () => {
  ...
  return { createCourseFolderPage, getCourseFolderPage, updateCourseFolderPage, duplicateCourseFolderPage, toggleCourseFolderPageAsCompleted, deleteCourseFolderPage };
};
