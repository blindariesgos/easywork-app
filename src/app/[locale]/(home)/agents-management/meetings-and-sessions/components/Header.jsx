...
import FilterManagements from "./FilterManagements";
...
export default function ManagementHeader() {
  ...
  const { displayFilters, removeFilter } = useManagementsContext();
  const options = [
    {
      name: "Junta de equipo",
      disabled: true,
    },
    { name: "Junta individual", disabled: true },
  ];
  return (
      ...
      <div className="px-4 flex flex-col gap-2  bg-white py-4 rounded-md shadow-sm w-full">
        <div className="flex gap-3 flex-wrap w-full items-center">
          <h1 className="text-2xl font-semibold leading-6 text-gray-900 hidden md:block">
            {t("agentsmanagement:meetings-and-sessions:title")}
          </h1>
          <Menu>
