...
const Control = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="pb-2 grid grid-cols-1 gap-2">
        {cardSelected && (
          <Fragment>
            <RadioGroup
              by="name"
              ...
              className="hidden md:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-2"
            >
              {cards(t).map((card) => (
                <Radio
                  key={card.id}
            ...
            <div className="md:hidden flex flex-col gap-4">
              ...
              <div className="group px-2 pb-2 pt-4 relative select-none grid grid-cols-1 gap-6  cursor-pointer transition focus:outline-none rounded-lg overflow-hidden border-[0.5px] border-primary">
                ...
                <p className="text-4xl text-right">{cardSelected.value}</p>
              </div>
            </div>
