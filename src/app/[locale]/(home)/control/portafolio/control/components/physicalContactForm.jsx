    ...
    <div className="py-4">
      <div className="bg-gray-100 p-4 grid gap-4">
        ...
        <div className="grid grid-cols-2 gap-4 ">
          ...
          <TextInput label={t("control:portafolio:control:form:curp")} />
          <SelectInput
          ...
          <TextInput label={t("control:portafolio:control:form:birthday")} />
          <SelectInput
            label={t("control:portafolio:control:form:gender")}
            options={[
              {
                name: "Femenino",
                id: 0,
            ...
            placeholder="- Seleccionar -"
          />
          <TextInput label={t("control:portafolio:control:form:postal-code")} />
        </div>
        <TextInput label={t("control:portafolio:control:form:address")} />
        <div className="grid grid-cols-2 gap-4">
          <SelectInput
            label={t("control:portafolio:control:form:state")}
            options={[
              {
                name: "estado 1",
                id: 0,
          ...
          />
          <SelectInput
            label={t("control:portafolio:control:form:city")}
            options={[
              {
                name: "ciudad 1",
                id: 0,
          ...
          />
          <SelectInput
            label={t("control:portafolio:control:form:municipality")}
            options={[
              {
                name: "municipio 1",
                id: 0,
        ...
        <TextInput
          label={t("control:portafolio:control:form:comment")}
          multiple
        />
        <div>
