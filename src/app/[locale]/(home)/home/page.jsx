							...
							<ul className="h-3/6 p-1">
								<li className="flex items-center mb-3">
									...
									<div className="ml-3">
										...
										<p className="text-xs text-slate-500">$2.500,00 Ago. 18, 2023</p>
									</div>
								</li>
								<li className="flex items-center mb-3">
									<Image
						...
						<div className="h-80 max-md:w-full bg-white rounded-lg p-2" style={{width: '38rem'}}>
							...
							<ul className="h-5/6 p-1 overflow-y-auto">
								<li className="flex items-center mb-3">
									...
									<div className="ml-3">
										<h3 className="text-sm">
											Lorena FloresM ha cumplimentado el popup Copia de Formulario Agencia popup
										</h3>
								...
								<li className="flex items-center mb-3">
									...
									/>
									<div className="ml-2">
										<h3 className="text-sm">Nathaly Gomez M. te ha asignado la tarea Cristian</h3>
								...
								<li className="flex items-center mb-3">
									...
									<div className="ml-2">
										<h3 className="text-sm">
											Nathaly Gomez M . Se ha vencido la tarea Seguimiento oportunidad “Naty Polin
											P-1”
										</h3>
										<p className="text-xs text-slate-500">hace 1 semana</p>
									</div>
								...
								<li className="flex items-center mb-3">
									...
									<div className="ml-2">
										<h3 className="text-sm">
											Esteban ha cumplimentado el formulario en agenciamunditodigital
										</h3>
										<p className="text-xs text-slate-500">hace 1 semana</p>
									</div>
								</li>
