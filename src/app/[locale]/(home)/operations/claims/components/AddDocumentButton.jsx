...
export default function AddDocumentButton({ id }) {
  ...
  const options = [
    ...
    {
      name: "Formato Auto-Certificación",
      type: "pago",
    },
    {
      name: "Formato Declaración de Siniestro",
      type: "pago",
    },
    {
    ...
    {
      name: "Formato Aviso de Accidente o Enfermedad",
      type: "pago",
    },
    {
    ...
    {
      name: "Información Adicional del Médico Tratante",
      type: "pago",
    },
    {
      name: "Facturas",
    ...
    {
      name: "Documento Aclaración - Inicial",
      type: "pago",
    },
    {
  ...
  return (
    <Fragment>
      ...
      <AddDocumentDialog
        ...
        update={() => {
          mutate(`/operations/claims/${id}/activities`);
        }}
      />
    </Fragment>
  );
