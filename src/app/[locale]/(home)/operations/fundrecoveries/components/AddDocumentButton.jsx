...
export default function AddDocumentButton({ id }) {
  ...
  const [addFileProps, setAddFileProps] = useState({
    isOpen: false,
    cmrType: "fundrecovery",
    id,
  });

  const options = [
    {
      name: "Carta conciencia",
      type: "pago",
    },
    {
      name: "Formato H-107",
    ...
    {
      name: "Formato 492 Identificación del cliente",
      type: "factura",
    },
    {
      name: "INE",
    ...
    {
      name: "Original de póliza",
      type: "pago",
    },
    {
      name: "Copia certificada acta de nacimiento",
      type: "pago",
    },
    {
      name: "Solicitud de movimientos fondos y valores",
      type: "pago",
    },
    {
    ...
    {
      name: "Formato oficial de invalidez",
      type: "pago",
    },
    {
      name: "Informe Médico",
    ...
    {
      name: "Dictámenes médicos",
      type: "pago",
    },
    {
      name: "Declaración medico tratante",
      type: "pago",
    },
    {
  ...
  return (
    <Fragment>
      ...
      <AddDocumentDialog
        ...
        update={() => {
          mutate(`/operations/fund-recoveries/${id}/activities`);
        }}
      />
    </Fragment>
  );
