...
import FilterFundRecoveries from "./FilterFundRecoveries";
...
export default function Header() {
  ...
  const { displayFilters, removeFilter } = useFundRecoveriesContext();
