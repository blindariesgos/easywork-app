								...
								<div className="flex flex-col gap-y-3 pl-2 pr-4 w-full">
									...
									<div className="bg-white rounded-lg p-4 mb-20">
										...
										<div className="mt-4">
											...
											<p className="mt-2">
												Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste quos ut
												officiis consectetur labore doloremque dolorum similique magni sit? Ut
												ex dignissimos repudiandae ratione eligendi cupiditate excepturi quia
												praesentium vero?
											</p>
											<div className="grid grid-cols-2 gap-4 mt-4">
												{files.map((file, index) => (
