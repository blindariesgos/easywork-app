...
export default function HeaderConsults({ noPolicy }) {
	...
	return (
		<div className="flex space-x-2 rounded-md w-full p-2 bg-white sm:flex-row flex-col sm:mt-8 mt-3 items-center lg:h-14">
			{policyConsult.map((policy, index) => (
				<div
					...
					className={classNames(
						...
						policy.route == pathname ? 'bg-blue-100 text-white shadow  px-2' : 'hover-off text-gray-400'
					)}
