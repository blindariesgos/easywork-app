						...
						<div className="w-full md:w-2/5 h-[72vh] overflow-y-scroll">
							<div className=" h-full w-full mb-10">
								<div className="flex flex-col gap-y-3 pl-2 pr-4 w-full">
									<TextInput
										type="text"
										label={t('contacts:edit:policies:claims:consult:responsible')}
										name="responsible"
									...
									<TextInput
										type="text"
										label={t('contacts:edit:policies:claims:consult:folio-number')}
										name="number-folio"
									...
									<TextInput
										type="text"
										label={t('contacts:edit:policies:claims:consult:folio-number1')}
										name="number-folio1"
										value={'12311'}
										disabled
									/>
