						...
						<div className="w-full md:w-2/5 h-[72vh] overflow-y-scroll">
							<div className=" h-full w-full mb-10">
								<div className="flex flex-col gap-y-3 pl-2 pr-4 w-full">
									<TextInput
										type="text"
										label={t('contacts:edit:policies:payments:consult:responsible')}
										name="responsible"
									...
									/>
									<SelectInput
										label={t('contacts:edit:policies:payments:consult:payment-method')}
										options={[]}
										value={'test'}
										name="payment-method"
										disabled
									...
									<TextInput
										type="text"
										label={t('contacts:edit:policies:payments:consult:date-start')}
										name="dateStart"
										value={'10/10/2024'}
										disabled
									/>
									<SelectInput
										label={t('contacts:edit:policies:payments:consult:expiration')}
										options={[]}
										value={'10/10/2024'}
										name="expiration"
										disabled
									...
									<TextInput
										type="text"
										label={t('contacts:edit:policies:payments:consult:comments')}
										name="comments"
