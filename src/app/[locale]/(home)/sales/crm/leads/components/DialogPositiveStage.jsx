...
export default function DialogPositiveStage({ isOpen, setIsOpen, setSelectedReason, selectedReason }) {
			...
			<Dialog as="div" className="relative z-50" onClose={closeModal}>
				...
				<div className="fixed inset-0 overflow-y-auto">
					<div className="flex min-h-full items-center justify-center p-4 text-center">
						...
						>
							<Dialog.Panel className="w-full max-w-md transform rounded-2xl bg-gray-100 p-6 text-left align-middle shadow-xl transition-all">
								...
								<div className="flex gap-2 justify-center mt-6">
                                    ...
                                    />
                                    <ButtonDiscardedPolicy setSelectedReason={setSelectedReason} selectedReason={selectedReason}/>
								</div>
							</Dialog.Panel>
						</Transition.Child>
					</div>
