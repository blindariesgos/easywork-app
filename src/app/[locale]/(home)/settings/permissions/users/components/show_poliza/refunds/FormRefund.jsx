              ...
              <div className=" h-full w-full mb-10">
                <div className="flex flex-col gap-y-3 pl-2 pr-4 w-full">
                  <TextInput
                    type="text"
                    label={t(
                      "contacts:edit:policies:refunds:consult:responsible"
                    )}
                    name="responsible"
                  ...
                  <TextInput
                    type="text"
                    label={t(
                      "contacts:edit:policies:refunds:consult:date-start"
                    )}
                    name="dateStart"
                    value={"10/10/2024"}
                    disabled
                  ...
                  <TextInput
                    type="text"
                    label={t(
                      "contacts:edit:policies:refunds:consult:number-claim"
                    )}
                    name="number-claim"
                    value={"0118180256"}
                    disabled
                  ...
                  <TextInput
                    type="text"
                    label={t(
                      "contacts:edit:policies:refunds:consult:folio-number"
                    )}
                    name="number-folio"
                  ...
                  <TextInput
                    type="text"
                    label={t(
                      "contacts:edit:policies:refunds:consult:diagnosis"
                    )}
                    name="diagnosis"
                  ...
                  <TextInput
                    type="text"
                    label={t(
                      "contacts:edit:policies:refunds:consult:folio-number1"
                    )}
                    name="number-folio1"
                    value={"12311"}
                    disabled
