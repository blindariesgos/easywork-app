    ...
    <div className="flex flex-col flex-grow">
      ...
      <div className="h-full">
        ...
        <FullCalendar
          ...
          selectMirror={true}
          initialEvents={[
            { title: "event 1", start: new Date().setHours(13, 0, 5) },
            { title: "event 2", start: new Date().setHours(14, 10, 5) },
            { title: "event 3", start: new Date().setHours(15, 30, 5) },
            { title: "event 4", start: new Date().setHours(16, 30, 5) },
            { title: "event 5", start: new Date().setHours(17, 40, 5) },
          ]}
        />
        {children}
      </div>
