...
export default function IconsInfo({ files }) {
    ...
    <div className="relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-5">
        {files.map((file) => (
          <div
            key={file.name}
            className="w-full h-full rounded-xl flex flex-col bg-[#E9E9E9] p-6"
          >
            <div className="flex gap-2 items-center">
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <MenuItems className="absolute right-0 bottom-0 z-50 mt-2.5 w-40 rounded-md bg-white py-2 shadow-lg focus:outline-none">
                            ...
                            {item.name !== "Compartir" ? (
                              ...
                              <Menu as="div" className="relative inline-block text-left">
                                ...
                                <Transition
                                  ...
                                  leaveTo="transform opacity-0 scale-95"
                                >
                                  <MenuItems className="absolute right-0 bottom-0 z-50 mt-2.5 w-56 rounded-md bg-white py-2 shadow-lg focus:outline-none">
