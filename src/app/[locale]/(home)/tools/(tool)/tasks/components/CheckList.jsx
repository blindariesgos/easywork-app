    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} >
                            ...
                            <div className='bg-gray-100 drop-shadow-lg rounded-lg p-2' >
                                <div className="flex w-full justify-between items-center p-2 pb-0 focus:ring-0 outline-none">
                                    {editTitleList[index] ? (
                                        <div className='border-b-2 border-gray-200 mb-2 w-full flex items-center' onClick={(e) => e.preventDefault()}>
                                            ...
                                            />
                                            <XMarkIcon className='h-3 w-3 text-red-600 mr-4' onClick={(e) => { e.preventDefault(); setValue(`items.${index}.name`, `${t('tools:tasks:new:verification-list')} ${`#${index + 1}`}`) }} />
                                        </div>
                                    ) : (
                                        <div
                                            ...
                                            onClick={() => {
                                                setEditTitleList({ ...editTitleList, [index]: !editTitleList[index] })
                                                setShowSave(true)
                                            }}
                                ...
                                <DisclosurePanel className="px-4 pb-2 text-sm text-gray-500">
                                    <ul>
                                        ...
                                        <ul className='pt-2'>
                                            {watch(`items.${index}.subItems`).map((subField, subIndex) => {
                                                return (
            ...
            <div className='flex gap-4 flex-wrap mt-4 items-center'>
                <button type="button" onClick={() => addList()} className='text-xs flex gap-2 items-center border-b border-dashed'>
                    <PlusIcon className='h-4 w-4' />
