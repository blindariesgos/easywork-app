        ...
        return (
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="relative text-gray-600 focus-within:text-gray-400">
                    ...
                    <input style={{ border: 'none' }} type="search" name="q" className="py-2 text-sm rounded-md pl-10 focus:text-gray-900 placeholder-slate-600" placeholder="N° de telefono/E-mail" autoComplete="off" />
                </div>
                {/* Video guia */}
