        ...
        return (
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="relative text-gray-600 focus-within:text-gray-400 mt-2">
                    ...
                    <input style={{ border: 'none' }} type="search" name="q" onChange={e => setEmail(e.target.value)} className="py-2 text-sm rounded-md pl-10 focus:text-gray-900" placeholder="E-mail" autoComplete="off" />
                </div>
                {/* info */}
                ...
                {/* boton */}
                <div>
                    <button onClick={() => sendData()} style={{ backgroundColor: "#262261" }} className="hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md">
