...
export default function Page() {
  return (
    <div className="bg-gradient-to-t from-sky-500 to-blue-300 h-screen w-screen overflow-x-hidden">
      ...
      <div className="relative bg-gradient-to-t from-lime-400 to-lime-100 h-96 flex items-start">
        <Image
      ...
      <div className="h-screen w-screen bg-lime-400 flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-center text-easywork-main">
          ...
          <p className="text-lg leading-tight text-center">
            Lo tiene todo.
            <br /> Todo el poder de nuestra herramienta a tu favor.
          </p>
        </div>
        ...
        <div className="">
          <div className="text-black flex flex-row">
            {[
              ...
              <div className="p-8 bg-gray-500 w-80 ml-5" key={index}>
