      ...
      <div className="mr-3 pb-10 w-full h-full overflow-y-auto">
        <div className="bg-white rounded-lg p-5">
          ...
          <p className="mt-3 p-2 text-white text-xs w-full bg-easywork-main">
            ...
            pantalla, y será visibles para todos los empleados.
          </p>
          <div className="mt-2">
              ...
              {activeTabIndexName == 1 && (
                <>
                  ...
                  <p className="text-xs mt-1">
                    La imagen que ve a la derecha muestra el aspecto que tendrá
                    su logotipo.
                  </p>
                </>
              )}
                  ...
                  {activeTabIndexAddress == 1 && (
                    <>
                      <p className="text-xs mt-2">
                        1. Agregue 4 registros de tipo &quot;IN NS&quot; en el editor DNS
                        de su dominio. Puede eliminar otros registros de este
                        dominio si existen.
                      </p>
                      ...
                      <p className="text-xs mt-2">
                        ...
                        prueba del cambio de los registros NS que hizo en el
                        paso 1. Puede ser una captura de pantalla del editor
                        DNS.
                      </p>
          ...
          {theme && (
            <>
              <p className="mt-3 text-sm w-full">
                ...
                Seleccione uno de los temas de stock o cree el fondo de su
                imagen empresarial.
                <br />
