...
export default function NotifyDrawer() {
  ...
  return (
    <Dialog className="relative z-10" open={isOpen} onClose={setIsOpen}>
      <DialogBackdrop
        transition
        className="fixed inset-0 bg-zinc-400 bg-opacity-75 transition-opacity duration-500 ease-in-out data-[closed]:opacity-0"
      />
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            ...
            >
              ...
              <div className="flex h-full divide-y divide-slate-400 flex-col overflow-y-scroll bg-zinc-300 py-6 shadow-xl">
