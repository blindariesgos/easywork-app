      ...
      <div className="fixed inset-0 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            ...
            >
              <TransitionChild>
                <div className="absolute left-0 top-5 rounded-l-lg -ml-8 flex justify-center items-center pr-3 py-1 bg-easywork-main duration-500 ease-in-out data-[closed]:opacity-0 sm:-ml-10 sm:pr-4">
                  <button
                    type="button"
              ...
              <div className="flex h-full divide-y divide-slate-400 flex-col overflow-y-scroll bg-[url('/img/fondo-home.png')] py-6 shadow-xl">
                <div className="px-4 sm:px-6">
                  <DialogTitle className="text-base font-semibold leading-6 text-gray-900 flex gap-2 items-center ">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5 w-8 h-8 text-slate-800">
